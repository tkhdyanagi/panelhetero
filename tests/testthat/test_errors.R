...
#-------------------------------------------------------------------------------
# testing errors for `nekcdf`
#-------------------------------------------------------------------------------

# errors for data
expect_error(nekcdf(data = NULL, acov_order = 0, acor_order = 1, mean_bw = 0.1, acov_bw = 0.1, acor_bw = 0.1))

expect_error(nekcdf(data = 1, acov_order = 0, acor_order = 1, mean_bw = 0.1, acov_bw = 0.1, acor_bw = 0.1))

expect_error(nekcdf(data = 1:10, acov_order = 0, acor_order = 1, mean_bw = 0.1, acov_bw = 0.1, acor_bw = 0.1))

expect_error(nekcdf(data = "x", acov_order = 0, acor_order = 1, mean_bw = 0.1, acov_bw = 0.1, acor_bw = 0.1))

# errors for acov_order
expect_error(nekcdf(data = y, acov_order = -1, acor_order = 1, mean_bw = 0.1, acov_bw = 0.1, acor_bw = 0.1))

expect_error(nekcdf(data = y, acov_order = 1:10, acor_order = 1, mean_bw = 0.1, acov_bw = 0.1, acor_bw = 0.1))

expect_error(nekcdf(data = y, acov_order = y, acor_order = 1, mean_bw = 0.1, acov_bw = 0.1, acor_bw = 0.1))

expect_error(nekcdf(data = y, acov_order = "x", acor_order = 1, mean_bw = 0.1, acov_bw = 0.1, acor_bw = 0.1))

# errors for acor_order
expect_error(nekcdf(data = y, acov_order = 0, acor_order = -1, mean_bw = 0.1, acov_bw = 0.1, acor_bw = 0.1))

expect_error(nekcdf(data = y, acov_order = 0, acor_order = 1:10, mean_bw = 0.1, acov_bw = 0.1, acor_bw = 0.1))

expect_error(nekcdf(data = y, acov_order = 0, acor_order = y, mean_bw = 0.1, acov_bw = 0.1, acor_bw = 0.1))

expect_error(nekcdf(data = y, acov_order = 0, acor_order = "x", mean_bw = 0.1, acov_bw = 0.1, acor_bw = 0.1))

# errors for mean_bw
expect_error(nekcdf(data = y, acov_order = 0, acor_order = 1, mean_bw = -1, acov_bw = 0.1, acor_bw = 0.1))

expect_error(nekcdf(data = y, acov_order = 0, acor_order = 1, mean_bw = 1:10, acov_bw = 0.1, acor_bw = 0.1))

expect_error(nekcdf(data = y, acov_order = 0, acor_order = 1, mean_bw = y, acov_bw = 0.1, acor_bw = 0.1))

expect_error(nekcdf(data = y, acov_order = 0, acor_order = 1, mean_bw = "x", acov_bw = 0.1, acor_bw = 0.1))


# errors for acov_bw
expect_error(nekcdf(data = y, acov_order = 0, acor_order = 1, mean_bw = 0.1, acov_bw = -1, acor_bw = 0.1))

expect_error(nekcdf(data = y, acov_order = 0, acor_order = 1, mean_bw = 0.1, acov_bw = 1:10, acor_bw = 0.1))

expect_error(nekcdf(data = y, acov_order = 0, acor_order = 1, mean_bw = 0.1, acov_bw = y, acor_bw = 0.1))

expect_error(nekcdf(data = y, acov_order = 0, acor_order = 1, mean_bw = 0.1, acov_bw = "x", acor_bw = 0.1))

# errors for acor_bw
expect_error(nekcdf(data = y, acov_order = 0, acor_order = 1, mean_bw = 0.1, acov_bw = 0.1, acor_bw = -1))

expect_error(nekcdf(data = y, acov_order = 0, acor_order = 1, mean_bw = 0.1, acov_bw = 0.1, acor_bw = 1:10))

expect_error(nekcdf(data = y, acov_order = 0, acor_order = 1, mean_bw = 0.1, acov_bw = 0.1, acor_bw = y))

expect_error(nekcdf(data = y, acov_order = 0, acor_order = 1, mean_bw = 0.1, acov_bw = 0.1, acor_bw = "x"))



#-------------------------------------------------------------------------------
# testing errors for `hpjkcdf`
#-------------------------------------------------------------------------------

# errors for data
expect_error(hpjkcdf(data = NULL, acov_order = 0, acor_order = 1, mean_bw = 0.1, acov_bw = 0.1, acor_bw = 0.1))

expect_error(hpjkcdf(data = 1, acov_order = 0, acor_order = 1, mean_bw = 0.1, acov_bw = 0.1, acor_bw = 0.1))

expect_error(hpjkcdf(data = 1:10, acov_order = 0, acor_order = 1, mean_bw = 0.1, acov_bw = 0.1, acor_bw = 0.1))

expect_error(hpjkcdf(data = "x", acov_order = 0, acor_order = 1, mean_bw = 0.1, acov_bw = 0.1, acor_bw = 0.1))

# errors for acov_order
expect_error(hpjkcdf(data = y, acov_order = -1, acor_order = 1, mean_bw = 0.1, acov_bw = 0.1, acor_bw = 0.1))

expect_error(hpjkcdf(data = y, acov_order = 1:10, acor_order = 1, mean_bw = 0.1, acov_bw = 0.1, acor_bw = 0.1))

expect_error(hpjkcdf(data = y, acov_order = y, acor_order = 1, mean_bw = 0.1, acov_bw = 0.1, acor_bw = 0.1))

expect_error(hpjkcdf(data = y, acov_order = "x", acor_order = 1, mean_bw = 0.1, acov_bw = 0.1, acor_bw = 0.1))

# errors for acor_order
expect_error(hpjkcdf(data = y, acov_order = 0, acor_order = -1, mean_bw = 0.1, acov_bw = 0.1, acor_bw = 0.1))

expect_error(hpjkcdf(data = y, acov_order = 0, acor_order = 1:10, mean_bw = 0.1, acov_bw = 0.1, acor_bw = 0.1))

expect_error(hpjkcdf(data = y, acov_order = 0, acor_order = y, mean_bw = 0.1, acov_bw = 0.1, acor_bw = 0.1))

expect_error(hpjkcdf(data = y, acov_order = 0, acor_order = "x", mean_bw = 0.1, acov_bw = 0.1, acor_bw = 0.1))

# errors for mean_bw
expect_error(hpjkcdf(data = y, acov_order = 0, acor_order = 1, mean_bw = -1, acov_bw = 0.1, acor_bw = 0.1))

expect_error(hpjkcdf(data = y, acov_order = 0, acor_order = 1, mean_bw = 1:10, acov_bw = 0.1, acor_bw = 0.1))

expect_error(hpjkcdf(data = y, acov_order = 0, acor_order = 1, mean_bw = y, acov_bw = 0.1, acor_bw = 0.1))

expect_error(hpjkcdf(data = y, acov_order = 0, acor_order = 1, mean_bw = "x", acov_bw = 0.1, acor_bw = 0.1))


# errors for acov_bw
expect_error(hpjkcdf(data = y, acov_order = 0, acor_order = 1, mean_bw = 0.1, acov_bw = -1, acor_bw = 0.1))

expect_error(hpjkcdf(data = y, acov_order = 0, acor_order = 1, mean_bw = 0.1, acov_bw = 1:10, acor_bw = 0.1))

expect_error(hpjkcdf(data = y, acov_order = 0, acor_order = 1, mean_bw = 0.1, acov_bw = y, acor_bw = 0.1))

expect_error(hpjkcdf(data = y, acov_order = 0, acor_order = 1, mean_bw = 0.1, acov_bw = "x", acor_bw = 0.1))

# errors for acor_bw
expect_error(hpjkcdf(data = y, acov_order = 0, acor_order = 1, mean_bw = 0.1, acov_bw = 0.1, acor_bw = -1))

expect_error(hpjkcdf(data = y, acov_order = 0, acor_order = 1, mean_bw = 0.1, acov_bw = 0.1, acor_bw = 1:10))
